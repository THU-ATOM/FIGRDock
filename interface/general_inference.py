...
cmd = f'\
    ...
    CUDA_VISIBLE_DEVICES=${{CUDA_VISIBLE_DEVICES:-{args.device}}} /opt/conda/bin/python {script_path} --user-dir {user_dir} {os.path.abspath(predict_sdf_dir)} --valid-subset {lmdb_name} \
