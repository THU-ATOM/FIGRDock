...
class UnimolPredictor:
    ...
    def preprocess(self, input_protein, input_ligand, input_docking_grid, output_ligand_name, output_ligand_dir, use_sidechain):
        ...
        processed_data = preprocessor.preprocess(input_protein, input_ligand, input_docking_grid, output_ligand_name, output_ligand_dir, use_sidechain=use_sidechain)
    ...
    def predict(self, input_protein:str, 
                ...
                batch_size:int,
                use_sidechain:str):
        lmdb_name = self.preprocess(input_protein, input_ligand, input_docking_grid, output_ligand_name, output_ligand_dir, use_sidechain)
    ...
    def predict_sdf(self, input_protein:str, 
                    ...
                    batch_size:int = 4, use_sidechain=None):
        # Step1:  
        # 调用self.preprocess预处理输入数据存储在.lmdb路径
        # 调用infer.py预测结果，valid_step调用task.forward，并将logging_output存入pkl中
